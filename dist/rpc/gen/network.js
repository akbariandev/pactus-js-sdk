...
export var pactus;
(function (pactus) {
    class GetNetworkInfoRequest extends pb_1.Message {
        #one_of_decls = [];
        constructor(data) {
            super();
    ...
    pactus.GetNetworkInfoRequest = GetNetworkInfoRequest;
    class GetNetworkInfoResponse extends pb_1.Message {
        #one_of_decls = [];
        constructor(data) {
            super();
        ...
        set total_sent_bytes(value) {
            pb_1.Message.setField(this, 2, value);
        }
        get total_received_bytes() {
            return pb_1.Message.getFieldWithDefault(this, 3, 0);
        }
        set total_received_bytes(value) {
            pb_1.Message.setField(this, 3, value);
        }
        get connected_peers_count() {
            return pb_1.Message.getFieldWithDefault(this, 4, 0);
        }
        set connected_peers_count(value) {
            pb_1.Message.setField(this, 4, value);
        }
        get connected_peers() {
            return pb_1.Message.getRepeatedWrapperField(this, PeerInfo, 5);
        }
        set connected_peers(value) {
            pb_1.Message.setRepeatedWrapperField(this, 5, value);
        }
        get sent_bytes() {
            return pb_1.Message.getField(this, 6);
        }
        set sent_bytes(value) {
        ...
        toObject() {
            ...
            if (this.connected_peers != null) {
                data.connected_peers = this.connected_peers.map((item) => item.toObject());
            }
        ...
        serialize(w) {
            ...
            if (this.connected_peers.length)
                writer.writeRepeatedMessage(5, this.connected_peers, (item) => item.serialize(writer));
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.sent_bytes, reader, reader.readInt32, reader.readInt64));
                        break;
                    case 7:
                        reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.received_bytes, reader, reader.readInt32, reader.readInt64));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    pactus.GetNetworkInfoResponse = GetNetworkInfoResponse;
    ...
    pactus.GetNodeInfoRequest = GetNodeInfoRequest;
    class GetNodeInfoResponse extends pb_1.Message {
        ...
        set clock_offset(value) {
            pb_1.Message.setField(this, 13, value);
        }
        get connection_info() {
            return pb_1.Message.getWrapperField(this, ConnectionInfo, 14);
        }
    ...
    pactus.GetNodeInfoResponse = GetNodeInfoResponse;
    class PeerInfo extends pb_1.Message {
        ...
        set consensus_keys(value) {
            pb_1.Message.setField(this, 5, value);
        }
        get consensus_addresses() {
            return pb_1.Message.getFieldWithDefault(this, 6, []);
        }
        set consensus_addresses(value) {
            pb_1.Message.setField(this, 6, value);
        }
        get services() {
        ...
        set received_bundles(value) {
            pb_1.Message.setField(this, 10, value);
        }
        get invalid_bundles() {
            return pb_1.Message.getFieldWithDefault(this, 11, 0);
        }
        set invalid_bundles(value) {
    ...
    pactus.PeerInfo = PeerInfo;
    class ConnectionInfo extends pb_1.Message {
        #one_of_decls = [];
        constructor(data) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        ...
        set inbound_connections(value) {
            pb_1.Message.setField(this, 2, value);
        }
        get outbound_connections() {
            return pb_1.Message.getFieldWithDefault(this, 3, 0);
        }
        set outbound_connections(value) {
            pb_1.Message.setField(this, 3, value);
        }
        static fromObject(data) {
    ...
    pactus.ConnectionInfo = ConnectionInfo;
    class UnimplementedNetworkService {
        static definition = {
            GetNetworkInfo: {
                ...
                requestDeserialize: (bytes) => GetNetworkInfoRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes) => GetNetworkInfoResponse.deserialize(new Uint8Array(bytes))
            },
            GetNodeInfo: {
                ...
                responseStream: false,
                requestSerialize: (message) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes) => GetNodeInfoRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes) => GetNodeInfoResponse.deserialize(new Uint8Array(bytes))
            }
        };
    }
    pactus.UnimplementedNetworkService = UnimplementedNetworkService;
    class NetworkClient extends grpc_1.makeGenericClientConstructor(UnimplementedNetworkService.definition, "Network", {}) {
        constructor(address, credentials, options) {
            super(address, credentials, options);
        }
        GetNetworkInfo = (message, metadata, options, callback) => {
            return super.GetNetworkInfo(message, metadata, options, callback);
        };
        GetNodeInfo = (message, metadata, options, callback) => {
            return super.GetNodeInfo(message, metadata, options, callback);
        };
    }
    pactus.NetworkClient = NetworkClient;
})(pactus || (pactus = {}));
